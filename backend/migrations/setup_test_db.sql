-- ============================================================
-- setup_test_db.sql
-- Run this once to set up the test database schema
-- psql -U postgres -d transaction_test_db -f setup_test_db.sql
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS categories_name_unique_active ON categories(name) WHERE deleted_at IS NULL;
...
CREATE INDEX IF NOT EXISTS idx_log_entity      ON log_history(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_log_action_time ON log_history(action_taken_at);
...
CREATE TABLE IF NOT EXISTS transaction_deletion_requests (
    id             SERIAL PRIMARY KEY,
